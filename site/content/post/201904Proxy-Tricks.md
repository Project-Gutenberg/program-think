...
　　它的代码仓库在“[这里](https://github.com/Anorov/PySocks)”。使用它，只需增加4行代码（如下），就可以让整个 Python 进程的网络链接都转向指定的 SOCKS 代理。
